var BBSceneSettings = React.createClass({
	...
	onChangeGeneral: function(event){
        ...
        var name = target.name;
        if(target.type == 'checkbox' && name=='pushFollowers') {
	...
	saveScene: function(){
		var thiss = this;
		jQuery('#bbvcvs-overlay').css({display: 'block'});

        if(this.state.settings.general.title == '') {
			jQuery('#bbvcvs-overlay').css({display: 'none'});
			jQuery.notify( 'Please enter Scene title', { globalPosition:"right bottom", className: 'error' });
			return;
		}
        
        if(this.state.settings.general.name == '') {
			jQuery('#bbvcvs-overlay').css({display: 'none'});
			jQuery.notify( 'Please enter Name ID', { globalPosition:"right bottom", className: 'error' });
			return;
		}
		...
		jQuery.post(
		    ...
		    function(response){
				...
				if(typeof response.status != undefined && response.status == 'ok') {
					...
					jQuery.notify( response.msg, { globalPosition:"right bottom", className: 'success' });
				} else {
					jQuery.notify( 'Failed', { globalPosition:"right bottom", className: 'error' });
				}
		    }
		);
	},
    ...
    render: function() {
        return (
			<div className="bbvcvs-wrapper">
				<div className="bbvcvs-breadcrumbs">
					<a id="bbvcvs-save-scene" className="bbvcvs-save-scene" href="javascript:;" onClick={this.saveScene}><span className="dashicons dashicons-admin-generic"></span> Save scene</a>
				</div>
				<div id="bbvcvs-overlay" className="bb-overlay"><span className="dashicons dashicons-update bb-rotating"></span></div>
    	                ...
    	                <div id="bb-vcvs-general-settings" className="bb-col-settings">
    	                    ...
    	                    <div className="inside tabs-container">
    	                        ...
    	                        <div id="bb-vcvs-general" className="tab-content active">
    	                            ...
    	                            <input type="number" step="1" className="bb-field" name="duration" value={this.state.settings.general.duration} onChange={this.onChangeGeneral} />
    								<span>px</span>
    	                            <div className="clear"></div>

                                    <span className="bb-label">Offset</span>
    	                            <input type="number" step="1" className="bb-field" name="offset" value={this.state.settings.general.offset} onChange={this.onChangeGeneral} />
    								<span>px</span>
    	                            <div className="clear"></div>
                                    <hr/>
                        ...
                        <div id="bb-vcvs-bs-settings" className="bb-col-settings">
    	                    ...
    	                    <div className="inside tabs-container">
    							...
    							<div id="bb-vcvs-transform" className="tab-content active">
    								...
    								<input type="number" step="1" className="bb-field" name="x" value={this.state.settings.init.x} onChange={this.onChangeInit} />
    								<span>px</span>
    								<div className="clear"></div>

    								<span className="bb-label">TranslateY</span>
    								<input type="number" step="1" className="bb-field" name="y" value={this.state.settings.init.y} onChange={this.onChangeInit} />
    								<span>px</span>
    								<div className="clear"></div>

    								<span className="bb-label">TranslateZ</span>
    								<input type="number" step="0.1" className="bb-field" name="z" value={this.state.settings.init.z} onChange={this.onChangeInit} />
    								<span>px</span>
    								<div className="clear"></div>
                                ...
                                <div id="bb-vcvs-position" className="tab-content">
    								...
    								<input type="number" step="1" className="bb-field" name="top" value={this.state.settings.init.top} onChange={this.onChangeInit} />
    								<span>px</span>
    								<div className="clear"></div>
                                    
                                    <span className="bb-label">Left</span>
    								<input type="number" step="1" className="bb-field" name="left" value={this.state.settings.init.left} onChange={this.onChangeInit} />
    								<span>px</span>
    								<div className="clear"></div>
                                    
                                    <span className="bb-label">Bottom</span>
    								<input type="number" step="1" className="bb-field" name="bottom" value={this.state.settings.init.bottom} onChange={this.onChangeInit} />
    								<span>px</span>
    								<div className="clear"></div>
                                    
                                    <span className="bb-label">Right</span>
    								<input type="number" step="1" className="bb-field" name="right" value={this.state.settings.init.right} onChange={this.onChangeInit} />
    								<span>px</span>
    								<div className="clear"></div>
                                </div>
                                ...
                                <div id="bb-vcvs-bsmisc" className="tab-content">
    								...
    								<input type="number" step="1" className="bb-field" name="width" value={this.state.settings.init.width} onChange={this.onChangeInit} />
    								<span>px</span>
    								<div className="clear"></div>
                                    
                                    <span className="bb-label">Height</span>
    								<input type="number" step="1" className="bb-field" name="height" value={this.state.settings.init.height} onChange={this.onChangeInit} />
    								<span>px</span>
    								<div className="clear"></div>
                        ...
                        <div id="bb-vcvs-as-settings" className="bb-col-settings">
    	                    ...
    	                    <div className="inside tabs-container">
                                ...
                                <div id="bb-vcvsac-transform" className="tab-content active">
        							...
        							<h4>Transform</h4>
        							<span className="bb-label">TranslateX</span>
                                    <input type="number" step="1" className="bb-field" name="x" value={this.state.settings.scroll.x} onChange={this.onChangeScroll} />
        							<span>px</span>
                                    <div className="clear"></div>

        							<span className="bb-label">TranslateY</span>
                                    <input type="number" step="1" className="bb-field" name="y" value={this.state.settings.scroll.y} onChange={this.onChangeScroll} />
        							<span>px</span>
                                    <div className="clear"></div>

        							<span className="bb-label">TranslateZ</span>
                                    <input type="number" step="0.1" className="bb-field" name="z" value={this.state.settings.scroll.z} onChange={this.onChangeScroll} />
        							<span>px</span>
                                    <div className="clear"></div>
                                ...
                                <div id="bb-vcvsac-position" className="tab-content">
                                    ...
                                    <span className="bb-label">Top</span>
        							<input type="number" step="1" className="bb-field" name="top" value={this.state.settings.scroll.top} onChange={this.onChangeScroll} />
        							<span>px</span>
        							<div className="clear"></div>
                                    
                                    <span className="bb-label">Left</span>
        							<input type="number" step="1" className="bb-field" name="left" value={this.state.settings.scroll.left} onChange={this.onChangeScroll} />
        							<span>px</span>
        							<div className="clear"></div>
                                    
                                    <span className="bb-label">Bottom</span>
        							<input type="number" step="1" className="bb-field" name="bottom" value={this.state.settings.scroll.bottom} onChange={this.onChangeScroll} />
        							<span>px</span>
        							<div className="clear"></div>
                                    
                                    <span className="bb-label">Right</span>
        							<input type="number" step="1" className="bb-field" name="right" value={this.state.settings.scroll.right} onChange={this.onChangeScroll} />
        							<span>px</span>
        							<div className="clear"></div>
                                </div>
                                ...
                                <div id="bb-vcvsac-asmisc" className="tab-content">
                                    ...
                                    <span className="bb-label">Width</span>
        							<input type="number" step="1" className="bb-field" name="width" value={this.state.settings.scroll.width} onChange={this.onChangeScroll} />
        							<span>px</span>
        							<div className="clear"></div>
                                    
                                    <span className="bb-label">Height</span>
        							<input type="number" step="1" className="bb-field" name="height" value={this.state.settings.scroll.height} onChange={this.onChangeScroll} />
        							<span>px</span>
        							<div className="clear"></div>
...
var BBScenePreview = React.createClass({
	...
	bbScrollMagic: function(){
		...
		var tweenSettings = {}, duration = 0, delay = 0, durationEase = 0, durationString = '0', offset = 0, triggerHook = 0.5, vertical = this.props.settings.general.vertical;
