...
if(!class_exists('BestBug_VcParam_Toggle'))
{
	class BestBug_VcParam_Toggle
	{
		function __construct()
		{
			...
			{
				WpbakeryShortcodeParams::addField('bb_toggle' , array($this, 'bb_toggle'), BESTBUG_SM_URL . 'assets/admin/js/bb-vcparam-toggle.js');

				wp_enqueue_style( 'bb_vcparam_toggle', BESTBUG_SM_URL . '/assets/admin/css/vcparam/vcparam-toggle.css' );
			}
		}
