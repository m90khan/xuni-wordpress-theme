...
if ( class_exists( 'WPBakeryShortCodesContainer' ) && ! class_exists( 'WPBakeryShortCode_Bb_Sm_Image_Group' ) ) {
	class WPBakeryShortCode_Bb_Sm_Image_Group extends WPBakeryShortCodesContainer {
	}
} else {
